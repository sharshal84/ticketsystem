...
import { Radio,Space,Table,Tooltip,Tag,Button,Layout,Row,Col,Checkbox,Typography,Modal,Dropdown,Input,Select,Form,Upload,Steps,message} from 'antd';
...
const getTickets=()=>{
    ...
    fetch(`${'http://localhost:8080'}/getCustomerTickets/${cust_name}`)
    .then((response) => {
        return response.json();
    }, (error) => {
        console.log(error);
